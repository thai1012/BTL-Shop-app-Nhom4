...
public class SizeAdapter extends RecyclerView.Adapter<SizeAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull SizeAdapter.Viewholder holder, int position) {
        ...
        if (selectedPosition==holder.getAdapterPosition()){
            holder.binding.sizeLayout.setBackground(ContextCompat.getDrawable(context,R.drawable.size_selected));
            holder.binding.sizeTxt.setTextColor(context.getResources().getColor(R.color.purple));
        }else {
            holder.binding.sizeLayout.setBackground(ContextCompat.getDrawable(context,R.drawable.size_unselected));
